                    ...
                    {uploads.map((upload) => {
                        ...
                        return (
                            <div
                                ...
                                style={{ background: "#2D2D2D" }} // Dark theme like the reference image
                            >
                                ...
                                <p className="text-gray-400">{config.kingdom} → {config.phylum} → {config.class}</p>
        ...
        {(!config.traits || (Array.isArray(config.traits) && config.traits.length === 0)) && (
            <span className="text-gray-500">No traits available</span>
                                ...
                                <div className="mt-4">
                                    ...
                                    <p className="text-gray-300">{config.natural_habitat?.biomes || "Unknown"}</p>
                                    <p className="text-gray-300">{config.natural_habitat?.geographical_distribution || "Unknown"}</p>
                                </div>
