...
const missions: Mission[] = [
    ...
    { id: 2, name: "Complete profile", description: "Fill in your profile data", rewards: [29] }, // Give them a rover/automaton without a location, we'll create a button that keeps track of the item that was created and show the user an option to "place" un-locationised items/structures
