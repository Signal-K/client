...
const planets = [
  { name: 'Mercury', color: 'bg-gray-400', image: '/assets/Planets/Mercury.png', link: '/scenes/mercury' },
  { name: 'Venus', color: 'bg-yellow-200', image: '/assets/Planets/Venus.png', link: '/scenes/venus' },
  { name: 'Earth', color: 'bg-blue-500', image: '/assets/Planets/Earth.png', link: '/scenes/earth' },
  { name: 'Mars', color: 'bg-red-500', image: '/assets/Planets/Mars.png', link: '/scenes/mars' },
  { name: 'Jupiter', color: 'bg-orange-300', image: '/assets/Planets/Jupiter.png', link: '/scenes/jupiter' },
  { name: 'Saturn', color: 'bg-yellow-600', image: '/assets/Planets/Saturn.png', link: '/scenes/saturn' },
  { name: 'Uranus', color: 'bg-cyan-300', image: '/assets/Planets/Uranus.png', link: '/scenes/uranus' },
  { name: 'Neptune', color: 'bg-blue-700', image: '/assets/Planets/Neptune.png', link: '/scenes/neptune' },
];
