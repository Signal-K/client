...
// Define a Milestone type explicitly to prevent deep inference
interface Milestone {
  name: string;
  ...
  useEffect(() => {
    fetch("/api/gameplay/milestones")
      ...
      .then((data) => {
        ...
        const sorted: MilestoneWeek[] = [...data.playerMilestones].sort(
        ...
        <div className="p-4">
          ...
          <div className="flex flex-wrap items-center justify-between mb-4 gap-2">
            ...
            <Button
              ...
              size="sm"
              onClick={() =>
                setCurrentWeekIndex(Math.min(milestones.length - 1, currentWeekIndex + 1))
              }
              className="border-[#7e22ce] bg-[#1e293b] hover:bg-[#581c87] hover:text-white"
