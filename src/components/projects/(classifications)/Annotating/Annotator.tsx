...
export default function ImageAnnotator({
    ...
    try {
      ...
      if (classificationData && hasMineralDeposit && anomalyId) {
        try {
          ...
          const { determineMineralType } = await import('@/src/utils/mineralAnalysis');
  ...
  return (
    ...
    >
      ...
      <div
        className={`${
          useHorizontalLayout ? "flex-shrink-0" : ""
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <h3 className="font-bold text-sm">
                  Mineral deposits can be found here
                </h3>
              </div>
            </div>
          </div>
            ...
            <div className="flex-1 min-h-0 flex flex-col md:flex-row gap-4 overflow-hidden px-2">
              ...
              <div
                className={`annotation-canvas-container ${
                  isDrawing ? "drawing" : ""
                } flex-1 min-h-0 overflow-hidden flex items-center justify-center bg-gray-900 rounded-lg`}
              >
                <AnnotationCanvas
                  canvasRef={canvasRef}
                  imageRef={imageRef}
