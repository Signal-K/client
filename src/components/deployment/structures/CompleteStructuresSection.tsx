...
import TelescopeBlock from "../equipment/Equipment/TelescopeBlock";
import SatelliteBlock from "../equipment/Equipment/SatelliteBlock";
import FutureStructures from "../equipment/Equipment/FutureStructures";
