...
export default function SatelliteProgressBar(props: SatelliteProgressBarProps) {
  ...
  const [stellar, setStellar] = React.useState<{
    temp: number | null;
    radius: number | null;
    mass?: number | null;
  } | null>(null);
  ...
  const [planetStats, setPlanetStats] = React.useState<null | {
    mass: number;
    radius: number;
    density: number;
    temp: number;
...
const handleCalculate = async () => {
  ...
  let planetType: "terrestrial" | "ocean" | "ice" | "gaseous" = "terrestrial";
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      {((i !== 1 && i !== 3) || investigationType !== "planet") && (
                        <div
                          style={{
                            color: "#e4eff0",
                            fontSize: 13,
          ...
          >
            ...
            >
              <svg
                ...
                style={{
                  transform:
                    investigationType === "weather" && weatherDirection === "left"
                      ? "scaleX(-1)"
                      : "none",
            ...
            {!hideCards &&
              steps.map((step, i) => {
                const isAbove = i % 2 === 1;
                const cardY = isAbove ? 40 : 140 + pxHeight + 100;
                const showPlanetInput =
                  investigationType === "planet" &&
                  ((i === 2 && elapsed >= 20 * 60 * 1000) || i === 3 || i === 4);
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      {/* Default: show description if not replaced above */}
                      {((i !== 1 && i !== 2 && i !== 3 && i !== 4) || investigationType !== "planet") &&
                        i === clampedStepIdx && (
                          <div style={{ color: "#e4eff0", fontSize: 15, marginBottom: 6 }}>
                            {step.description}
                            {/* Weather classify button */}
            ...
            {/* Segment text box below progress bar if on root route */}
            {isRoot && (
              <div
                style={{
