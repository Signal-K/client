...
import TipsPanel from "@/src/components/deployment/missions/structures/Milestones/NextStepsTips";

interface TipsGuidanceSectionProps {
  showTipsPanel: boolean;
  onToggleTipsPanel: () => void;
}

export default function TipsGuidanceSection({
  showTipsPanel,
  onToggleTipsPanel,
}: TipsGuidanceSectionProps) {
  return (
