...
export const CoMSCategories: Record<CoMShapesCategory, CategoryConfig> = {
  "CloudyRegion": {
    ...
    iconUrl: '/assets/Docs/LIDAR/lidar-martianClouds/other-general.webp'
  },
  "Ozone": {
    name: "Ozone",
    description: "Pink region on the map",
    color: "#ff3398",
    iconUrl: '/assets/Docs/LIDAR/lidar-martianClouds/ozone.webp',
  },
  "CanyonCrater": {
    name: "Canyon / Crater",
    color: "#1a13dc",
    description: "Depressed region on the map with a blue tint",
    iconUrl: '/assets/Docs/LIDAR/lidar-martianClouds/crater.webp',
  },
  "Twilightzonecloud": {
    name: "Twilight zone cloud",
    color: '#f20c26',
    description: 'A cloud near the red terminator line',
    iconUrl: '/assets/Docs/LIDAR/lidar-martianClouds/twilight.webp',
  },
  "Streakcloud": {
    name: 'Streak cloud',
    color: '#770cf2',
    description: 'Long, narrow and straight feature',
    iconUrl: '/assets/Docs/LIDAR/lidar-martianClouds/streak.webp',
  },
  "Diskcloud": {
    name: 'Disk cloud',
    color: '#44ba25',
    description: "Small round circles that resemble disks or caps",
    iconUrl: '/assets/Docs/LIDAR/lidar-martianClouds/disk.webp',
  },
  "Vortexcloud": {
    name: "Vortex Cloud",
    color: '#dcc40e',
    description: 'A cloud that turns in on itself, with a spiral shape',
    iconUrl: '/assets/Docs/LIDAR/lidar-martianClouds/vortex.webp',
  },
  "Dottedcloud": {
    name: 'Dotted cloud',
    color: '#7bb9d1',
    description: 'Small patches of clouds without strict direction or structure',
    iconUrl: '/assets/Docs/LIDAR/lidar-martianClouds/dotted.webp',
  },
  'Gravitywavecloud': {
    ...
    color: '#0c749d',
    iconUrl: '/assets/Docs/LIDAR/lidar-martianClouds/gravitywave.webp',
  },
  "Othercloudtype": {
