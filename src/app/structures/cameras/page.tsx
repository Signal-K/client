...
const ChatGPTImageClassifier = dynamic(
  ...
  { ssr: false, loading: () => <div className="p-4 text-xs text-slate-500">Loading classifier...</div> }
);
...
export default function CameraAggregatesPage() {
  ...
  const buttons = [
    { icon: <MicroscopeIcon className="w-6 h-6 text-[#B48EAD]" />, text: "Animal tracker", dynamicComponent: <ChatGPTImageClassifier /> },
    { icon: <CloudCogIcon className="w-6 h-6 text-[#88C0D0]" />, text: "Storm chaser - coming soon" },
  ];
              ...
              <>
                <div className="flex justify-between items-center">
                  <div className="flex items-center space-x-2">
                    ...
                    <h1 className="text-2xl font-bold text-[#2E3440]">Your cameras (across all structures)</h1>
                  </div>
                </div>

                <div className="flex justify-center my-4">
                  <img src='/assets/Items/cameras.png' alt="Your cameras" className="w-20 h-20" width='80' height='80' style={{ aspectRatio: '80/80', objectFit: 'cover' }} />
                </div>
                  ...
                  <div className="flex items-center justify-center my-4 space-x-4">
                    {buttons.map((button, index) => (
                      <div
                        ...
                        onClick={() => button.dynamicComponent && setActiveComponent(button.dynamicComponent)}
