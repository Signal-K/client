...
const AllAutomatonModules: React.FC = () => {
                  ...
                  if (ownedItemsData) {
                      ...
                      if (itemDetailsData) {
                          const structuresData: { ownedItem: OwnedItem; structure: UserStructure }[] = itemDetailsData
                              .filter(itemDetail => itemDetail.ItemCategory === 'AutomatonModule' && itemIds.includes(itemDetail.id))
                              .map(itemDetail => {
  ...
  return (
      <div className="container mx-auto p-6 bg-gray-100 dark:bg-gray-800 rounded-lg shadow-lg">
          <h2 className="text-2xl font-semibold mb-4 text-center">Your Automaton Modules</h2>
