...
export default function HomebaseSelector(factionId) {
    ...
    const { id, created_at, content, coverUrl } = planetData || {};
        ...
        <>
            <Card noPadding={false}>
                <div 
                    ...
                    style={{
                        backgroundImage:
                          'url("https://images.unsplash.com/photo-1446776811953-b23d57bd21aa?q=80&w=2372&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")',
                    }}
                >
            ...
            <div className="h-grow px-10">
                <h1 className="text-center text-slate-300 text-opacity-100 font-['Inter'] tracking-[3.48px] mt-[-50px] mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white text-gray-400">{content}</h1>
            </div>
        </>
    );
};