...
function MagicLinkView ({ email, setEmail, setAuthView }: MagicLinkViewProps): JSX.Element {
    ...
    return (
        <>
            <h1 className="text-2xl leading-6 font-semibold dark:text-white" id='modal-headline'>Sign In</h1>
            <p className="text-sm my-2 text-gray-600 dark:text-gray-200">Your comment will be saved（ꉺ౪ꉺ）</p>
            <div>
                <div>
                    <button
...
function AwaitingConfirmationView ({
    ...
    return (
        <div className="flex flex-col items-center">
            <h1 className="text-2xl leading-6 font-semibold text-gray-900 dark:text-white" id='modal-headline'>Confirm your email</h1>
            <div className="my-4 text-center leading-loose">
                ...
                <p>Click the link in the email to sign in/up</p>
            </div>
        </div>
    );
}
