...
import { AI4MWrapper, AiForMarsProject, AiForMarsProjectWithID, StarterAiForMars } from "@/components/Projects/Auto/AI4Mars";
        ...
        return [
            {
                ...
                points: 2,
                completedCount: 0,
                internalComponent: () => <AiForMarsProjectWithID />,
                color: "text-blue-500",
            }, 
            {
                id: 2,
