...
interface PreferredTerrestrialClassificationsProps {
    ...
    classifiyingAnomalyId: ( anomalyId: string ) => void;
};

export default function PreferredTerrestrialClassificationsWithHardcodedAnomalyId({
    onSelectAnomaly,
    classifiyingAnomalyId,
    ...
    return (
        <div>
            {loading ? (
                ...
                <p>No compatible terrestrial planets found.</p>
            ) : (
                <div
                    className={
                ...
                >
                    {classifications.map(( classification ) => (
                        <Card
                            ...
                            className={`bg-white/10 backdrop-blue-md border border-white/10 shadow-lg rounded-lg ${
            ...
            {selectedAnomaly && isVehicleSelectionFocused && (
                <div className="mt-6 w-full h-full">
                    <h3 className="text-lg font-semibold text-gray-800">Select an automaton</h3>
            ...
            <Link href='/planets/mars'>
                <Button className="bg-blue-300">
                    View classification aggregates
                </Button>
            </Link>
        </div>
    );
