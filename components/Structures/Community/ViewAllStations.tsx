...
export function StationsOnPlanetOpen() {
  const supabase = useSupabaseClient();
  const session = useSession();
...
return (
    <div className="stations-container">
      {stationsOnPlanet.map((station) => (
        <Link href="/starnet/consensus"><div key={station.id}>
        ...
        <div className="modal">
          <div className="modal-content">
            ...
            <CommunityScienceStation
              ...
              projects={selectedStation.projects}
              missions={selectedStation.missions}
              anomalies={selectedStation.anomalies || []}
              imageSrc={selectedStation.imageSrc}
              configuration={selectedStation.configuration}
              inventoryItemId={selectedStation.InventoryItemId}
              onClick={closeModal}
            />
