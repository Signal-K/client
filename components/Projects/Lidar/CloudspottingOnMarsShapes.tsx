        ...
        async function fetchAnomaly() {
            ...
            try {
                ...
                if (supabaseUrl && randomAnomaly?.id) {
                    setImageUrl(`${supabaseUrl}/storage/v1/object/public/telescope/balloon-marsCloudsShapes/${randomAnomaly.id}/${randomAnomaly.id}/1.png`);
                    setBaseImageUrl(`${supabaseUrl}/storage/v1/object/public/telescope/balloon-marsCloudsShapes/${randomAnomaly.id}/${randomAnomaly.id}/2.png`);
                } else {
