...
const navigation = [
  ...
  {
    name: 'Documentation', href: '/garden'
  },
  {
    name: 'My stuff', href: '/gather'
  },
  {
    name: 'Inbox', href: '/inventory' // I think we should probably have a page for building as well, maybe even feed, faction, but I want to see a 4-pronged approach for now
  },
];

const NavLogo = () => (
  <img className="h-8 w-8" src='https://static.tildacdn.com/tild6231-3430-4164-a131-633766663164/noroot.png' alt='Star Sailors' />
);
      ...
      >
        <div className='flex lg:flex-1'>
          <a href='/' className='-m-1.5 p-1.5'>
            <img className='h-8 w-8' src='https://raw.githubusercontent.com/Signal-K/client/cfb8ed95f403e4109ecc2760417ff1134369ba52/public/planet.svg' alt='Star Sailors' />
          </a>
        </div>
