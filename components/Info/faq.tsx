            ...
            <div className="grid pt-8 text-left border-t border-gray-200 md:gap-16 dark:border-gray-700 md:grid-cols-2">
                <div>
                    <div className="mb-10">
                        ...
                        <Link href='https://discord.gg/NQBKGrQuUX'><p className="text-gray-500 dark:text-gray-400">We've got a page with some different tutorials on what to look for, and a discord server (click here) to compare results, discuss findings & get help</p></Link>
                    </div>
                </div>
                <div>
                <div className="mb-10">                        
