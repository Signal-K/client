    ...
    return (
        <Card noPadding={false}>
            <div className={styles.paddingThing}>
                <h2>Navigation</h2>
                {/*<Link legacyBehavior href ='/' className={pathname === '/' ? activeElementClass : elementClass}>Home</Link>*/}
                <a href='/posts' className={styles.activeSidebarNavItem}>
                ...
                <a href='/posts' className={styles.sidebarNavItems}>
