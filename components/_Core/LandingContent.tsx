...
import {
  ...
  modules,
  navigation,
} from "./Section/Info/LandingContent";
import {
    UserDropdownMenu,
    UserMenuItems,
  } from "./Section/Navbar";
...
export default function PublicLanding () {
    ...
    const NavLogo = () => (
      <img
        className="h-8 w-8"
        src="https://avatars.githubusercontent.com/u/78838067?s=200&v=4"
        alt="Star Sailors"
      />
    );
            ...
            <div id="modules" className="mx-auto mt-48 max-w-7xl px-6 lg:px-8">
              <div className="mx-auto max-w-2xl text-center">
                ...
                <p className="mt-6 text-lg leading-8 text-gray-600 dark:text-white">
                  Explore the cosmos & catalogue discoveries in different scientific
                  disciplines
                </p>
              </div>
