...
CREATE TABLE IF NOT EXISTS "public"."defensive_probes" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "event_id" "uuid",
    "user_id" "uuid",
    "count" integer DEFAULT 1,
    "launched_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "defensive_probes_count_check" CHECK (("count" >= 1))
);


ALTER TABLE "public"."defensive_probes" OWNER TO "postgres";
...
ALTER TABLE "public"."solar_events" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."user_mineral_inventory" (
    "id" bigint NOT NULL,
    "user_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."user_mineral_inventory" OWNER TO "postgres";


DO $$
BEGIN
  ALTER TABLE "public"."user_mineral_inventory" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."user_mineral_inventory_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
EXCEPTION WHEN SQLSTATE '42P07' OR SQLSTATE '42710' OR SQLSTATE '42P16' THEN
  NULL; -- Constraint or relation already exists, continue
END $$;
...
DO $$
BEGIN
  ALTER TABLE ONLY "public"."defensive_probes"
    ADD CONSTRAINT "defensive_probes_pkey" PRIMARY KEY ("id");
EXCEPTION WHEN SQLSTATE '42P07' OR SQLSTATE '42710' OR SQLSTATE '42P16' THEN
  NULL; -- Constraint or relation already exists, continue
END $$;
...
DO $$
BEGIN
  ALTER TABLE ONLY "public"."solar_events"
    ADD CONSTRAINT "solar_events_pkey" PRIMARY KEY ("id");
EXCEPTION WHEN SQLSTATE '42P07' OR SQLSTATE '42710' OR SQLSTATE '42P16' THEN
  NULL; -- Constraint or relation already exists, continue
END $$;
...
DO $$
BEGIN
  ALTER TABLE ONLY "public"."user_mineral_inventory"
    ADD CONSTRAINT "user_mineral_inventory_pkey" PRIMARY KEY ("id");
EXCEPTION WHEN SQLSTATE '42P07' OR SQLSTATE '42710' OR SQLSTATE '42P16' THEN
  NULL; -- Constraint or relation already exists, continue
END $$;
...
CREATE INDEX IF NOT EXISTS "idx_defensive_probes_event_id" ON "public"."defensive_probes" USING "btree" ("event_id");



CREATE INDEX IF NOT EXISTS "idx_defensive_probes_user_id" ON "public"."defensive_probes" USING "btree" ("user_id");



CREATE INDEX IF NOT EXISTS "idx_linked_anomalies_author_automaton_unlocked" ON "public"."linked_anomalies" USING "btree" ("author", "automaton", "unlocked");



CREATE INDEX IF NOT EXISTS "idx_linked_anomalies_unlock_time" ON "public"."linked_anomalies" USING "btree" ("unlock_time") WHERE ("unlock_time" IS NOT NULL);



CREATE INDEX IF NOT EXISTS "idx_linked_anomalies_unlocked" ON "public"."linked_anomalies" USING "btree" ("unlocked") WHERE ("unlocked" IS NOT NULL);



CREATE INDEX IF NOT EXISTS "idx_notification_rejections_profile_id" ON "public"."notification_rejections" USING "btree" ("profile_id");



CREATE INDEX IF NOT EXISTS "idx_nps_surveys_created_at" ON "public"."nps_surveys" USING "btree" ("created_at" DESC);



CREATE INDEX IF NOT EXISTS "idx_nps_surveys_nps_score" ON "public"."nps_surveys" USING "btree" ("nps_score");



CREATE INDEX IF NOT EXISTS "idx_nps_surveys_user_id" ON "public"."nps_surveys" USING "btree" ("user_id");



CREATE INDEX IF NOT EXISTS "idx_push_anomaly_log_anomaly_id" ON "public"."push_anomaly_log" USING "btree" ("anomaly_id");



CREATE INDEX IF NOT EXISTS "idx_push_anomaly_log_sent_at" ON "public"."push_anomaly_log" USING "btree" ("sent_at");



CREATE INDEX IF NOT EXISTS "idx_routes_author" ON "public"."routes" USING "btree" ("author");



CREATE INDEX IF NOT EXISTS "idx_routes_location" ON "public"."routes" USING "btree" ("location");



CREATE INDEX IF NOT EXISTS "idx_routes_timestamp" ON "public"."routes" USING "btree" ("timestamp" DESC);



CREATE INDEX IF NOT EXISTS "idx_solar_events_week_start" ON "public"."solar_events" USING "btree" ("week_start");



CREATE INDEX IF NOT EXISTS "idx_user_mineral_inventory_extracted_at" ON "public"."user_mineral_inventory" USING "btree" ("extracted_at" DESC);



CREATE INDEX IF NOT EXISTS "idx_user_mineral_inventory_mineral_deposit_id" ON "public"."user_mineral_inventory" USING "btree" ("mineral_deposit_id");



CREATE INDEX IF NOT EXISTS "idx_user_mineral_inventory_user_id" ON "public"."user_mineral_inventory" USING "btree" ("user_id");



CREATE INDEX IF NOT EXISTS "ix_vector_cosine_ops_hnsw_m16_efc64_8291b92" ON "vecs"."image_vectors" USING "hnsw" ("vec" "public"."vector_cosine_ops") WITH ("m"='16', "ef_construction"='64');
...
CREATE OR REPLACE TRIGGER "update_solar_events_updated_at" BEFORE UPDATE ON "public"."solar_events" FOR EACH ROW EXECUTE FUNCTION "public"."trigger_set_timestamp"();
...
ALTER TABLE ONLY "public"."defensive_probes"
    ADD CONSTRAINT "defensive_probes_event_id_fkey" FOREIGN KEY ("event_id") REFERENCES "public"."solar_events"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."defensive_probes"
    ADD CONSTRAINT "defensive_probes_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."mineralDeposits"
    ADD CONSTRAINT "mineraldeposits_discovery_fkey" FOREIGN KEY ("discovery") REFERENCES "public"."classifications"("id");
...
ALTER TABLE ONLY "public"."user_mineral_inventory"
    ADD CONSTRAINT "user_mineral_inventory_mineral_deposit_id_fkey" FOREIGN KEY ("mineral_deposit_id") REFERENCES "public"."mineralDeposits"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."user_mineral_inventory"
    ADD CONSTRAINT "user_mineral_inventory_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;
...
CREATE POLICY "Users can delete own mineral inventory" ON "public"."user_mineral_inventory" FOR DELETE USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can insert own mineral inventory" ON "public"."user_mineral_inventory" FOR INSERT WITH CHECK (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can update own mineral inventory" ON "public"."user_mineral_inventory" FOR UPDATE USING (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can view own mineral inventory" ON "public"."user_mineral_inventory" FOR SELECT USING (("auth"."uid"() = "user_id"));
...
GRANT ALL ON TABLE "public"."defensive_probes" TO "anon";
GRANT ALL ON TABLE "public"."defensive_probes" TO "authenticated";
GRANT ALL ON TABLE "public"."defensive_probes" TO "service_role";
...
GRANT ALL ON TABLE "public"."solar_events" TO "anon";
GRANT ALL ON TABLE "public"."solar_events" TO "authenticated";
GRANT ALL ON TABLE "public"."solar_events" TO "service_role";
...
GRANT ALL ON TABLE "public"."user_mineral_inventory" TO "anon";
GRANT ALL ON TABLE "public"."user_mineral_inventory" TO "authenticated";
GRANT ALL ON TABLE "public"."user_mineral_inventory" TO "service_role";



GRANT ALL ON SEQUENCE "public"."user_mineral_inventory_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."user_mineral_inventory_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."user_mineral_inventory_id_seq" TO "service_role";
...
using ((bucket_id = 'bumble'::text));
  ...
  to authenticated
using ((bucket_id = 'bumble'::text))
with check ((bucket_id = 'bumble'::text));
