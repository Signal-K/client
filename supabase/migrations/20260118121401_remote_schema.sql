...
CREATE INDEX "idx_defensive_probes_event_id" ON "public"."defensive_probes" USING "btree" ("event_id");



CREATE INDEX "idx_defensive_probes_user_id" ON "public"."defensive_probes" USING "btree" ("user_id");
...
CREATE INDEX "idx_solar_events_week_start" ON "public"."solar_events" USING "btree" ("week_start");



CREATE INDEX "idx_user_mineral_inventory_extracted_at" ON "public"."user_mineral_inventory" USING "btree" ("extracted_at" DESC);



CREATE INDEX "idx_user_mineral_inventory_mineral_deposit_id" ON "public"."user_mineral_inventory" USING "btree" ("mineral_deposit_id");



CREATE INDEX "idx_user_mineral_inventory_user_id" ON "public"."user_mineral_inventory" USING "btree" ("user_id");
