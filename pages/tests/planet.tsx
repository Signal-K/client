  ...
  return (
        ...
        <div className="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
          ...
          >
            <div className="p-4 md:p-12 text-center lg:text-left">
              ...
              />
              <h1 className="text-3xl font-bold pt-8 lg:pt-0 mb-2">
                {content}
              </h1>
          ...
          Contract info: {planetData?.contract}
              ...
              {session?.user?.id && (
                <>
                  ...
                  <UserContext.Provider value={{ profile }}>
                    <PostFormCardPlanetTag
                      planetId2={planetId}
                      onPost={() => fetchPostsForPlanet(planetId)}
                    />
              ...
              {hasMadePostOnPlanet && (
                <>
                  ...
                  <Link
                    legacyBehavior
                    href="/tests/onboarding/checklist/preflight"
                  >
                    <button className="btn glass">Return to planet list</button>
                  </Link>
                </>
              )}
    ...
    >
      ...
      <path d="M3.5 13C2.7 13 2 13.7 2 14.5S2.7 16 3.5 16 5 15.3 5 14.5 4.3 13 3.5 13zM3.5 9C2.7 9 2 9.7 2 10.5S2.7 12 3.5 12 5 11.3 5 10.5 4.3 9 3.5 9zM3.5 5C2.7 5 2 5.7 2 6.5S2.7 8 3.5 8 5 7.3 5 6.5 4.3 5 3.5 5zM20 12h-8c-1.1 0-2 .9-2 2v8c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2v-8c0-1.1-.9-2-2-2zm0 10h-8v-8h8v8z" />
                ...
                >
                  <a className="link" href="#" data-tippy-content="Gameplay">
      ...
      {/* <UnityBuildLod111 /> */} {/* <UnityBuildSupabaseTest /> */}{" "}
      {/* <UnityBuildLod1 /> */} {/* <UnityBuildLod1Mars /> */}
    </CoreLayout>
  )
}