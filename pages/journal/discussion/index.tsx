import Layout from '../../../components/Journal/Discussion/Layout';
  ...
  return (
    <Layout>
      ...
      <h2 className='is-size-4 mb-5'>
        An open-source forum <br></br>
        Create your discussion platform and deploy it completely free, Using &ldquo;Seven-stack&rdquo; (Supabase, Vercel and Next.js).
