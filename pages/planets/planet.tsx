                ...
                <Card noPadding={true}>
                    <div className="relative overflow-hidden rounded-md">
                        ...
                        <div className="ml-24 md:ml-40 mt-1">
                            <div className="flex ml--2"> {/* Profile Name - Set up styling rule to remove the ml-10 on mobile */}<h1 className="text-3xl font-bold">{planet?.name}</h1>{/* Only show userma,e on mouseover, along with the address (like a metamask profile view) <p className="@apply text-blue-200 leading-4 mb-2 mt-2">{profile?.username}</p>*/}</div>
                        ...
                        <br /><br />
                        <p>Owner of this anomaly: {planet?.ownerId2}</p>
                        {planet?.ownerId2 == session?.user?.id /*&& planet?.userId == username*/ && (
                            <div>Hello World</div>
                        )}
                        <br /><br /><br />
                        </div>
